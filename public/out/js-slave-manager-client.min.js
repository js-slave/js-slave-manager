...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"center-div center-txt\">\n	<h1>jsbot-manager</h1>\n\n	<a href=\"#/addEvent\" id=\"addButton\" class=\"button-xlarge pure-button pure-button-primary\">Add</a>\n	<br><br>\n	<a href=\"#/list\" id=\"listButton\" class=\"button-xlarge pure-button pure-button-primary\">List</a>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BotsRunnedCollection = __webpack_require__(42);

	var _BotsRunnedCollection2 = _interopRequireDefault(_BotsRunnedCollection);
	...
	var ListView = function (_Backbone$View) {
	  ...
	  */
		...
		function ListView() {
			...
			_this.botsRunnedCollection = new _BotsRunnedCollection2.default();
			_this.botsRunnedCollection.fetch().then(function () {
				_this.render();
			});
			return _this;
		}
	  ...
	  */
		...
		_createClass(ListView, [{
			key: 'render',
			value: function render() {
				this.$el.html((0, _list2.default)(this.botsRunnedCollection.toJSON()));
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BotRunned = __webpack_require__(43);

	var _BotRunned2 = _interopRequireDefault(_BotRunned);
	...
	var BotsRunnedCollection = function (_Backbone$Collection) {
		_inherits(BotsRunnedCollection, _Backbone$Collection);
	  ...
	  */
		...
		function BotsRunnedCollection(options) {
			_classCallCheck(this, BotsRunnedCollection);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BotsRunnedCollection).call(this, options));

			_this.model = _BotRunned2.default;
			_this.url = '/list';
			return _this;
		}

		return BotsRunnedCollection;
	}(_backbone2.default.Collection);

	exports.default = BotsRunnedCollection;

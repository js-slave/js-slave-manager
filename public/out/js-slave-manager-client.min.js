...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AddView = __webpack_require__(5);

	var _AddView2 = _interopRequireDefault(_AddView);

	var _AddActionView = __webpack_require__(31);

	var _AddActionView2 = _interopRequireDefault(_AddActionView);

	var _AddEventView = __webpack_require__(35);

	var _AddEventView2 = _interopRequireDefault(_AddEventView);

	var _HomeView = __webpack_require__(38);

	var _HomeView2 = _interopRequireDefault(_HomeView);

	var _ListView = __webpack_require__(40);

	var _ListView2 = _interopRequireDefault(_ListView);

	var _ManageSlavesView = __webpack_require__(44);

	var _ManageSlavesView2 = _interopRequireDefault(_ManageSlavesView);
	...
	var Router = function (_Backbone$Router) {
	  ...
	  */
		...
		_createClass(Router, [{
			key: 'home',
			value: function home() {
				this._appendView(new _HomeView2.default());
			}
	   ...
	   */
			...
			value: function addAction() {
				this._appendView(new _AddActionView2.default());
			}
	   ...
	   */
			...
			value: function addEvent() {
				this._appendView(new _AddEventView2.default());
			}
	   ...
	   */
			...
			key: 'add',
			value: function add() {
				this._appendView(new _AddView2.default());
			}
	   ...
	   */
			...
			key: 'list',
			value: function list() {
				this._appendView(new _ListView2.default());
			}
	   ...
	   */
			...
			key: 'manageSlaves',
			value: function manageSlaves() {
				this._appendView(new _ManageSlavesView2.default());
			}
	   ...
	   */
			...
			key: '_appendView',
			value: function _appendView(view) {
				view.render();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ActionModel = __webpack_require__(26);

	var _ActionModel2 = _interopRequireDefault(_ActionModel);

	var _AddModel = __webpack_require__(28);

	var _AddModel2 = _interopRequireDefault(_AddModel);

	var _EventModel = __webpack_require__(29);
	...
	var AddView = function (_Backbone$View) {
	  ...
	  */
		...
		function AddView() {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AddView).call(this, {
				events: {
			...
			_this.action = new _ActionModel2.default(_store2.default.get('action'));
			_this.event = new _EventModel2.default(_store2.default.get('event'));
			return _this;
		}
	  ...
	  */
		...
		_createClass(AddView, [{
			...
			value: function submit(e) {
				e.preventDefault();
				var addModel = new _AddModel2.default({
					action: this.action,
					event: this.event
				});
				$('.overlay').show();
				addModel.save().success(function () {
					_backbone2.default.history.navigate('', true);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"\">\n	<h1 class=\"center-txt\">Add - Confirmation</h1>\n\n	<div class=\"event padding-default\">\n		<h2>"
	    ...
	    + "\n			<br><br>\n			<h3>Parameters</h3>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.params : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "		</p>\n	</div>\n	<div id=\"arrow\" class=\"center-div\"></div>\n	<div class=\"action padding-default\">\n		<h2>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.action : depth0)) != null ? stack1.name : stack1), depth0))
	    + "</h2>\n		<p>\n			"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.action : depth0)) != null ? stack1.description : stack1), depth0))
	    + "\n		</p>\n	</div>\n	<form id=\"add-form\" class=\"center-txt pure-form\">\n		<fieldset>\n			<button type=\"submit\" class=\"pure-button pure-button-primary button-xxlarge button-success\">Validate</button>\n		</fieldset>\n	</form>\n\n	<div class=\"center-txt div-button-back\">\n		<a href=\"#/addAction\" id=\"button-back\" class=\"button-xlarge pure-button pure-button-primary\">Back</a>\n	</div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ParamModel = __webpack_require__(27);

	var _ParamModel2 = _interopRequireDefault(_ParamModel);
	...
	var ActionModel = function (_Backbone$Model) {
		_inherits(ActionModel, _Backbone$Model);

		function ActionModel() {
			_classCallCheck(this, ActionModel);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(ActionModel).apply(this, arguments));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ParamModel = function (_Backbone$Model) {
		_inherits(ParamModel, _Backbone$Model);

		function ParamModel() {
			_classCallCheck(this, ParamModel);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(ParamModel).apply(this, arguments));
		}

		_createClass(ParamModel, [{
			key: 'defaults',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddModel = function (_Backbone$Model) {
		_inherits(AddModel, _Backbone$Model);
	  ...
	  */
		...
		function AddModel(options) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AddModel).call(this, options));
	  ...
	  */
		...
		_createClass(AddModel, [{
			...
			value: function defaults() {
				return {
					action: _ActionModel2.default,
					event: _EventModel2.default
				};
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventModel = function (_Backbone$Model) {
		_inherits(EventModel, _Backbone$Model);

		function EventModel() {
			_classCallCheck(this, EventModel);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(EventModel).apply(this, arguments));
		}
	   ...
	   */
			value: function defaults() {
				return {
					...
					description: '',
					params: _ParamModel2.default,
					returnedValues: _ParamModel2.default
				};
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ActionsCollection = __webpack_require__(32);

	var _ActionsCollection2 = _interopRequireDefault(_ActionsCollection);

	var _addAction = __webpack_require__(34);
	...
	var AddActionView = function (_Backbone$View) {
		_inherits(AddActionView, _Backbone$View);
	  ...
	  */
		...
		function AddActionView() {
			_classCallCheck(this, AddActionView);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AddActionView).call(this, {
				events: {
			...
			_this.actions = new _ActionsCollection2.default();
			_this.actions.fetch().then(function () {
				_this.render();
			});
			return _this;
		}
	  ...
	  */
		...
		_createClass(AddActionView, [{
			key: 'clickOnSelect',
			value: function clickOnSelect(e) {
	   ...
	   */
			...
			value: function submit(e) {
				...
				var selects = $(e.currentTarget).find('select');
				...
				var categoryModel = this.actions.get(categoryId);

				if (actionModel === null) {
					actionModel = new _ActionModel2.default(categoryModel.get('actions')[actionId]);
					...
					try {
						for (var _iterator3 = actionModel.get('params')[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
							...
							try {
								for (var _iterator4 = customValues[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
									var customValue = _step4.value;
				...
				_store2.default.set('action', actionModel);
				_backbone2.default.history.navigate('add', true);
			}
	   ...
	   */
			...
			value: function render() {
				if (this.actions.length === 0) {
					this.$el.html((0, _addAction2.default)());
				} else {
					this.$el.html((0, _addAction2.default)({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CategoryModel = __webpack_require__(33);
	...
	var ActionsCollection = function (_Backbone$Collection) {
		_inherits(ActionsCollection, _Backbone$Collection);
	  ...
	  */
		...
		function ActionsCollection(options) {
			_classCallCheck(this, ActionsCollection);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ActionsCollection).call(this, options));

			_this.model = _CategoryModel2.default;
			_this.url = '/actions';
			return _this;
		}
	...
	exports.default = ActionsCollection;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CategoryModel = function (_Backbone$Model) {
		_inherits(CategoryModel, _Backbone$Model);

		function CategoryModel() {
			_classCallCheck(this, CategoryModel);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(CategoryModel).apply(this, arguments));
		}
	   ...
	   */
			value: function defaults() {
				return {
					id: -1,
					categoryName: '',
					events: _EventModel2.default,
					actions: _ActionModel2.default
				};
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
	  ...
	  return "		<h2>"
	    + container.escapeExpression(((helper = (helper = helpers.categoryName || (depth0 != null ? depth0.categoryName : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"categoryName","hash":{},"data":data}) : helper)))
	    + "</h2>\n\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.actions : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0, blockParams, depths),"inverse":container.program(10, data, 0, blockParams, depths),"data":data})) != null ? stack1 : "");
	},"2":function(container,depth0,helpers,partials,data,blockParams,depths) {
	    var stack1, helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

	  return "			<ul class=\"actions\">\n				<li class=\"action padding-default\">\n					<p>\n						<h3>"
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "</h3>\n						"
	    + alias4(((helper = (helper = helpers.description || (depth0 != null ? depth0.description : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"description","hash":{},"data":data}) : helper)))
	    + "\n						<br><br>\n						<form class=\"action-form pure-form\">\n							<fieldset>\n								<input type=\"hidden\" name=\"categoryId\" value=\""
	    + alias4(container.lambda((depths[1] != null ? depths[1].id : depths[1]), depth0))
	    + "\">\n								<input type=\"hidden\" name=\"actionId\" value=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.params : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "								<br>\n								<button type=\"submit\" class=\"pure-button pure-button-primary\">Choose</button>\n							</fieldset>\n						</form>\n					</p>\n				</li>\n			</ul>\n";
	  ...
	  return "									"
	    ...
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "</label>\n\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.value : depth0),{"name":"if","hash":{},"fn":container.program(4, data, 0, blockParams, depths),"inverse":container.program(7, data, 0, blockParams, depths),"data":data})) != null ? stack1 : "")
	    + "\n									<br><br>\n";
	  ...
	  return "										<select id=\""
	    ...
	    + "\" name=\""
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "\" class=\"pure-input\" required>\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.value : depth0),{"name":"each","hash":{},"fn":container.program(5, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "										</select>\n";
	  ...
	  return "										<select id=\""
	    ...
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "\" class=\"pure-input\" required>\n"
	    + ((stack1 = helpers.each.call(alias1,(depths[3] != null ? depths[3].returnedValues : depths[3]),{"name":"each","hash":{},"fn":container.program(8, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	  ...
	  return "												<option value=\""
	    ...
	    return "			<p class=\"center-txt\">\n				<br>\n				You have to install slaves with actions...\n			</p>\n";
	},"12":function(container,depth0,helpers,partials,data) {
	    return "		<p class=\"center-txt\">\n			<br>\n			Your installed slaves don't have available action...\n		</p>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams,depths) {
	    var stack1;

	  return "<div class=\"\">\n	<h1 class=\"center-txt\">Add - Action</h1>\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.actions : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.program(12, data, 0, blockParams, depths),"data":data})) != null ? stack1 : "")
	    + "\n	<div class=\"center-txt div-button-back\">\n		<a href=\"#/addEvent\" id=\"button-back\" class=\"button-xlarge pure-button pure-button-primary\">Back</a>\n	</div>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _addEvent = __webpack_require__(36);

	var _addEvent2 = _interopRequireDefault(_addEvent);

	var _EventsCollection = __webpack_require__(37);
	...
	var AddEventView = function (_Backbone$View) {
		_inherits(AddEventView, _Backbone$View);
	  ...
	  */
		...
		function AddEventView() {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AddEventView).call(this, {
				events: {
			...
			_this.events = new _EventsCollection2.default();
			_this.events.fetch().then(function () {
				_this.render();
			});
			return _this;
		}
	  ...
	  */
		...
		_createClass(AddEventView, [{
			...
			value: function submit(e) {
				...
				try {
					for (var _iterator = inputs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
						...
						if (inputSelected.attr('name') === 'categoryId') {
							...
							var name = inputSelected.attr('name');
							var value = inputSelected.val();
							var categoryModel = this.events.get(categoryId);

							if (eventModel === null) {
								eventModel = new _EventModel2.default(categoryModel.get('events')[eventId]);
							...
							try {
								for (var _iterator2 = eventModel.get('params')[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
				...
				_store2.default.set('event', eventModel);
				_backbone2.default.history.navigate('addAction', true);
			}
	   ...
	   */
			...
			key: 'render',
			value: function render() {
				this.$el.html((0, _addEvent2.default)(this.events.length === 0 ? null : this.events.toJSON()));
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
	  ...
	  return "		<h2>"
	    + container.escapeExpression(((helper = (helper = helpers.categoryName || (depth0 != null ? depth0.categoryName : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"categoryName","hash":{},"data":data}) : helper)))
	    + "</h2>\n\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.events : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0, blockParams, depths),"inverse":container.program(7, data, 0, blockParams, depths),"data":data})) != null ? stack1 : "");
	},"2":function(container,depth0,helpers,partials,data,blockParams,depths) {
	    var stack1, helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

	  return "			<ul class=\"events\">\n				<li class=\"event padding-default\">\n					<p>\n						<h3>"
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "</h3>\n						"
	    + alias4(((helper = (helper = helpers.description || (depth0 != null ? depth0.description : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"description","hash":{},"data":data}) : helper)))
	    + "\n						<br><br>\n						<h4>Parameters</h4>\n						<form class=\"event-form pure-form\">\n							<fieldset>\n								<input type=\"hidden\" name=\"categoryId\" value=\""
	    + alias4(container.lambda((depths[1] != null ? depths[1].id : depths[1]), depth0))
	    ...
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.returnedValues : depth0),{"name":"each","hash":{},"fn":container.program(5, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "					</p>\n				</li>\n			</ul>\n";
	},"3":function(container,depth0,helpers,partials,data,blockParams,depths) {
	  ...
	  return "								<label for=\""
	    ...
	    + "\" name=\""
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "\" class=\"pure-input-1-3\" type=\"text\" placeholder=\""
	    + alias4(((helper = (helper = helpers.description || (depth0 != null ? depth0.description : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"description","hash":{},"data":data}) : helper)))
	    + "\" required>\n								<br>\n";
	},"5":function(container,depth0,helpers,partials,data) {
	    var helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;
	  ...
	  return "							<strong>"
	    ...
	    return "			<p class=\"center-txt\">\n				<br>\n				You have to install slaves with events...\n			</p>\n";
	},"9":function(container,depth0,helpers,partials,data) {
	    return "		<p class=\"center-txt\">\n			<br>\n			Your installed slaves don't have available events...\n		</p>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams,depths) {
	    var stack1;

	  return "<div class=\"\">\n	<h1 class=\"center-txt\">Add - Event</h1>\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},depth0,{"name":"each","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.program(9, data, 0, blockParams, depths),"data":data})) != null ? stack1 : "")
	    + "\n	<div class=\"center-txt div-button-back\">\n		<a href=\"#/\" id=\"button-back\" class=\"button-xlarge pure-button pure-button-primary\">Back</a>\n	</div>\n</div>\n";
	},"useData":true,"useDepths":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventsCollection = function (_Backbone$Collection) {
		_inherits(EventsCollection, _Backbone$Collection);
	  ...
	  */
		...
		function EventsCollection(options) {
			_classCallCheck(this, EventsCollection);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(EventsCollection).call(this, options));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"center-div center-txt\">\n	<h1>jsbot-manager</h1>\n\n	<a href=\"#/addEvent\" class=\"button-xlarge pure-button pure-button-primary\">Add</a>\n	<br><br>\n	<a href=\"#/list\" class=\"button-xlarge pure-button pure-button-primary\">List</a>\n	<br><br>\n	<a href=\"#/manageSlaves\" class=\"button-xlarge pure-button pure-button-primary\">Manage slaves</a>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SlavesRunnedCollection = __webpack_require__(42);

	var _SlavesRunnedCollection2 = _interopRequireDefault(_SlavesRunnedCollection);
	...
	var ListView = function (_Backbone$View) {
	  ...
	  */
		...
		function ListView() {
			...
			_this.slavesRunnedCollection = new _SlavesRunnedCollection2.default();
			_this.slavesRunnedCollection.fetch().then(function () {
				_this.render();
			});
			return _this;
		}
	  ...
	  */
		...
		_createClass(ListView, [{
			...
			value: function _delete(e) {
				...
				$.ajax({
					...
					_this2.slavesRunnedCollection.fetch().then(function () {
						_this2.render();
					});
				}).fail(function (error) {
					console.log(error);
	   ...
	   */
			...
			key: 'render',
			value: function render() {
				this.$el.html((0, _list2.default)(this.slavesRunnedCollection.toJSON()));
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "		<div class=\"pure-g\">\n			<div class=\"event pure-u-1-4\">\n				<div class=\"margin-default\">\n					<h2>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.name : stack1), depth0))
	    + "</h2>\n					<p>\n						"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.description : stack1), depth0))
	    + "\n						<br><br>\n						<h3>Parameters</h3>\n"
	    + ((stack1 = helpers.each.call(alias3,((stack1 = (depth0 != null ? depth0.event : depth0)) != null ? stack1.params : stack1),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "					</p>\n				</div>\n			</div>\n			<div class=\"pure-u-1-4\">\n				<div id=\"arrow-horizontal\"></div>\n			</div>\n			<div class=\"action pure-u-1-4\">\n				<div class=\"margin-default\">\n					<h2>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.action : depth0)) != null ? stack1.name : stack1), depth0))
	    + "</h2>\n					<p>\n						"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.action : depth0)) != null ? stack1.description : stack1), depth0))
	    + "\n					</p>\n				</div>\n			</div>\n			<div class=\"pure-u-1-4 center-txt\">\n				<button id=\"button-delete\" data-id=\""
	    ...
	    + "\" class=\"margin-default center-vertical pure-button pure-button-primary button-xxlarge button-error\">Delete</button>\n			</div>\n		</div>\n";
	  ...
	  return "						<strong>"
	    ...
	    return "		<p class=\"center-txt\">\n			<br>\n			You have to add slaves first...\n			<br><br>\n			<a href=\"#/addEvent\" class=\"button-xlarge pure-button pure-button-primary\">Add</a>\n		</p>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<div>\n	<h1 class=\"center-txt\">List</h1>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},depth0,{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "")
	    + "	<div class=\"center-txt div-button-back\">\n		<a href=\"#/\" class=\"button-xlarge pure-button pure-button-primary\">Back</a>\n	</div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SlaveRunned = __webpack_require__(43);

	var _SlaveRunned2 = _interopRequireDefault(_SlaveRunned);
	...
	var SlavesRunnedCollection = function (_Backbone$Collection) {
		_inherits(SlavesRunnedCollection, _Backbone$Collection);
	  ...
	  */
		...
		function SlavesRunnedCollection(options) {
			_classCallCheck(this, SlavesRunnedCollection);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SlavesRunnedCollection).call(this, options));

			_this.model = _SlaveRunned2.default;
			_this.url = '/list';
			return _this;
		}

		return SlavesRunnedCollection;
	}(_backbone2.default.Collection);

	exports.default = SlavesRunnedCollection;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BotRunned = function (_Backbone$Model) {
		_inherits(BotRunned, _Backbone$Model);

		function BotRunned() {
			_classCallCheck(this, BotRunned);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(BotRunned).apply(this, arguments));
		}

		_createClass(BotRunned, [{
			key: 'defaults',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _manageSlaves = __webpack_require__(49);

	var _manageSlaves2 = _interopRequireDefault(_manageSlaves);

	var _SlavesCollection = __webpack_require__(50);

	var _SlavesCollection2 = _interopRequireDefault(_SlavesCollection);
	...
	var ManageSlavesView = function (_Backbone$View) {
		_inherits(ManageSlavesView, _Backbone$View);

		/**
	  * Create an instance of ManageSlavesView
	  */

		function ManageSlavesView() {
			_classCallCheck(this, ManageSlavesView);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ManageSlavesView).call(this, {
				events: {
			...
			_this.slavesCollection = new _SlavesCollection2.default();
			_this.slavesCollection.fetch().then(function () {
				_this.render();
			});
			return _this;
		}
	  ...
	  */
		...
		_createClass(ManageSlavesView, [{
			key: 'postApi',
			value: function postApi(url, params) {
				var _this2 = this;

				$('.overlay').show();
				$.post(url, params).done(function () {
					_this2.slavesCollection.fetch().then(function () {
						_this2.render();
					});
				}).fail(function (error) {
					console.log(error);
	   ...
	   */
			...
			key: 'render',
			value: function render() {
				this.$el.html((0, _manageSlaves2.default)(this.slavesCollection.toJSON()));
			}
		}]);

		return ManageSlavesView;
	}(_backbone2.default.View);

	exports.default = ManageSlavesView;
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../css-loader/index.js!./loaders.min.css", function() {
				var newContent = require("!!./../css-loader/index.js!./loaders.min.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "		<div class=\"center-div center-txt\">\n			<h2>"
	    ...
	    + "</h2>\n			<p>\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.version : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.installed : depth0),{"name":"if","hash":{},"fn":container.program(4, data, 0),"inverse":container.program(7, data, 0),"data":data})) != null ? stack1 : "")
	    + "				<br><br>\n			</p>\n		</div>\n";
	},"2":function(container,depth0,helpers,partials,data) {
	    var helper;
	  ...
	  return ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.newVersion : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "					<button data-name=\""
	    + container.escapeExpression(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "\" class=\"pure-button pure-button-primary button-xxlarge button-error button-uninstall\">Uninstall</button>\n";
	},"5":function(container,depth0,helpers,partials,data) {
	    var helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

	  return "						<button data-name=\""
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "\" class=\"pure-button pure-button-primary button-xxlarge button-success button-upgrade\">Upgrade to "
	  ...
	  return "					<button data-name=\""
	    ...
	    + "\" class=\"pure-button pure-button-primary button-xxlarge button-success button-install\">Install</button>\n";
	},"9":function(container,depth0,helpers,partials,data) {
	    return "		<p class=\"center-txt\">\n			<br>\n			No slave found...<br>\n			Please verify that there are slaves inside the file \"slaves.json\".\n		</p>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<div>\n	<h1 class=\"center-txt\">Manage slaves</h1>\n	<br>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},depth0,{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(9, data, 0),"data":data})) != null ? stack1 : "")
	    + "\n	<div class=\"center-txt div-button-back\">\n		<a href=\"#/\" class=\"button-xlarge pure-button pure-button-primary\">Back</a>\n	</div>\n</div>\n\n<div class=\"overlay\" style=\"display:none;\">\n	<div style=\"margin-top: 10%;\">\n		<p class=\"center-txt\">Loading...</p>\n		<div class=\"center-div\" data-loader=\"arrow-circle\"></div>\n	</div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SlaveModel = __webpack_require__(51);

	var _SlaveModel2 = _interopRequireDefault(_SlaveModel);
	...
	var SlavesCollection = function (_Backbone$Collection) {
		_inherits(SlavesCollection, _Backbone$Collection);
	  ...
	  */
		...
		function SlavesCollection(options) {
			_classCallCheck(this, SlavesCollection);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SlavesCollection).call(this, options));

			_this.model = _SlaveModel2.default;
			_this.url = '/slaves';
			return _this;
		}
	...
	exports.default = SlavesCollection;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SlaveModel = function (_Backbone$Model) {
		_inherits(SlaveModel, _Backbone$Model);

		function SlaveModel() {
			_classCallCheck(this, SlaveModel);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(SlaveModel).apply(this, arguments));
		}

		_createClass(SlaveModel, [{
			key: 'defaults',
